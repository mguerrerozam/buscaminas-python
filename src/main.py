...
import pygame
import sys
from utils import COLORES #IMPORTA EL DICCIONARIO CON LOS RGB DE LOS COLORES A UTILIZAR EN LA UI. EJEMPLO DE SINTAXIS: AZUL=COLORES['AZUL']
...
def main(): #SE DEFINE LA FUNCIÓN MAIN POR MODULARIDAD Y FACILIDAD PARA EL TESTEO
    ...
    pantalla=pygame.display.set_mode(()) #DEFINE LA VARIABLE PANTALLA Y ESTABLECE SU ANCHO Y ALTO (EN PÍXELES)
    ...
    while ejecutando: #BUCLE QUE SE REPITE MIENTRAS LA VARIABLE EJECUTANDO SEA VERDADERA
        pass #COMANDO QUE NO HACE NADA, PERO SE DEJA AQUÍ PARA QUE EN EL FUTURO SE PUEDA AGREGAR CÓDIGO SIN TENER QUE MODIFICAR LA ESTRUCTURA DEL BUCLE
